...
许多面试官会认为，基本的计算机科学知识实际上是有用的。要清楚，需要用到树、图、列表、排序和其他知识的情况隔段时间肯定会出现。如果真是这样的话，掌握进本的知识真的很有必要。

难倒不可以遇到问题的时候根据需要有选择地学习吗？当然可以。但是如果你不知道二叉搜索树的存在，你就很难在需要的时候知道应该去使用它。如果你知道它的存在，那么你具有了基本的概念。
